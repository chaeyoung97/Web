<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 try {
		...
		String sql = "SELECT * FROM board WHERE content LIKE '%"+keyword+"%' or title LIKE '%"+keyword+"%' order by date desc"; //시간순으로 내림차순 정렬해서 출력
	...
	%>
		...
		<table>
			...
			<tr>
				 ...
				 <td style ="width:70%; height:25px;text-align:left;font-wight:bold;font-size:20px">&nbsp;제목: <a href = "show.jsp?no=<%=deleteNo%>"><%=rs.getString("title") %></a></td>
		    ...
		    <tr>
		   		<th style ="width:100%; height:50px;" colspan = "3" ><a href = "show.jsp?no=<%=deleteNo%>">댓글달기</a></th>
		   </tr>
